  ...
  server.tool(
    ...
    'Generate an echarts image from a given echarts configuration',
    {
      ...
      echarts: z
        .string()
        .describe(
          "echarts configuration, like { backgroundColor: '#fff', title: {text: 'Stock financial data'}, tooltip: {}, legend: {data: ['sales']}, xAxis: {data: ['Shirts', 'Cardigans', 'Chiffons', 'Pants', 'Heels', 'Socks']}, yAxis: {}, series: [{name: 'sales', type: 'bar', data: [5, 20, 36, 10, 10, 20]}] }"
        ),
    },
